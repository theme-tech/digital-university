            ...
            buildprogress: function(h, s, e, d) {
                ...
                g.slider.addEventListener("focus", function() {
                    ...
                    if (1e3 <= new Date - u && (c = g.paused), g.options.enableKeyboard && g.options.keyActions.length) {
                        ...
                        r = r < 0 || isNaN(r) ? 0 : n <= r ? n : Math.floor(r), u = new Date, c || h.pause(), r < g.getDuration() && !c && setTimeout(f, 1100), g.setCurrentTime(r), h.showControls(), e.preventDefault(), e.stopPropagation()
                    }
                });
    ...
    14: [function(e, t, n) {
        ...
        Object.assign(w.config, {
            ...
            buildvolume: function(e, t, n, o) {
                if (!T.IS_ANDROID && !T.IS_IOS || !this.options.hideVolumeOnTouchDevices) {
                    var a = this,
                        s = a.isVideo ? a.options.videoVolume : a.options.audioVolume,
                        r = (0, C.isString)(a.options.muteText) ? a.options.muteText : P.default.t("mejs.mute"),
                        l = (0, C.isString)(a.options.unmuteText) ? a.options.unmuteText : P.default.t("mejs.unmute"),
                        i = (0, C.isString)(a.options.allyVolumeControlText) ? a.options.allyVolumeControlText : P.default.t("mejs.volume-help-text"),
                    ...
                    if (d.className = a.options.classPrefix + "button " + a.options.classPrefix + "volume-button " + a.options.classPrefix + "mute", d.innerHTML = "horizontal" === s ? '<button type="button" aria-controls="' + a.id + '" title="' + r + '" aria-label="' + r + '" tabindex="0"></button>' : '<button type="button" aria-controls="' + a.id + '" title="' + r + '" aria-label="' + r + '" tabindex="0"></button><a href="javascript:void(0);" class="' + a.options.classPrefix + 'volume-slider" aria-label="' + P.default.t("mejs.volume-slider") + '" aria-valuemin="0" aria-valuemax="100" role="slider" aria-orientation="vertical"><span class="' + a.options.classPrefix + 'offscreen">' + i + '</span><div class="' + a.options.classPrefix + 'volume-total"><div class="' + a.options.classPrefix + 'volume-current"></div><div class="' + a.options.classPrefix + 'volume-handle"></div></div></a>', a.addControlElement(d, "volume"), a.options.keyActions.push({
                            keys: [38],
                            action: function(e) {
                                var t = e.getElement(e.container).querySelector("." + w.config.classPrefix + "volume-slider");
                            ...
                            keys: [77],
                            action: function(e) {
                                e.getElement(e.container).querySelector("." + w.config.classPrefix + "volume-slider").style.display = "block", e.isVideo && (e.showControls(), e.startControlsTimer()), e.media.muted ? e.setMuted(!1) : e.setMuted(!0)
                            }
                        }), "horizontal" === s) {
                    ...
                    var c = !1,
                        ...
                        b = function() {
                            a.muted ? (y(0), (0, k.removeClass)(d, a.options.classPrefix + "mute"), (0, k.addClass)(d, a.options.classPrefix + "unmute")) : (y(o.volume), (0, k.removeClass)(d, a.options.classPrefix + "unmute"), (0, k.addClass)(d, a.options.classPrefix + "mute"))
                        };
            ...
            return o(r, [{
                ...
                value: function() {
                    ...
                    if (n.isDynamic = "audio" !== t && "video" !== t && "iframe" !== t, n.isVideo = n.isDynamic ? n.options.isVideo : "audio" !== t && n.options.isVideo, n.mediaFiles = null, n.trackFiles = null, w.IS_IPAD && n.options.iPadUseNativeControls || w.IS_IPHONE && n.options.iPhoneUseNativeControls) n.node.setAttribute("controls", !0), w.IS_IPAD && n.node.getAttribute("autoplay") && n.play();
                        ...
                        var o = n.isVideo ? y.default.t("mejs.video-player") : y.default.t("mejs.audio-player"),
                        ...
                        if (w.IS_ANDROID && P.addClass(n.getElement(n.container), n.options.classPrefix + "android"), w.IS_IOS && P.addClass(n.getElement(n.container), n.options.classPrefix + "ios"), w.IS_IPAD && P.addClass(n.getElement(n.container), n.options.classPrefix + "ipad"), w.IS_IPHONE && P.addClass(n.getElement(n.container), n.options.classPrefix + "iphone"), P.addClass(n.getElement(n.container), n.isVideo ? n.options.classPrefix + "video" : n.options.classPrefix + "audio"), w.IS_SAFARI && !w.IS_IOS) {
                            P.addClass(n.getElement(n.container), n.options.classPrefix + "hide-cues");
                    ...
                    if (v.default.MepDefaults = e, new g.default(n.media, e, n.mediaFiles), void 0 !== n.getElement(n.container) && n.options.features.length && n.controlsAreVisible && !n.options.hideVideoControlsOnLoad) {
                ...
                value: function() {
                    ...
                    (n ? -1 === n.indexOf("%") && (n += "px") : n = "auto", o ? -1 === o.indexOf("%") && (o += "px") : o = "auto", l.node.style.width = n, l.node.style.height = o, l.setPlayerSize(0, 0), l.isDynamic ? l.getElement(l.container).parentNode.insertBefore(l.node, l.getElement(l.container)) : function() {
                        ...
                        (e && l.node.setAttribute("poster", e.src), delete l.node.autoplay, l.node.setAttribute("src", ""), "" !== l.media.canPlayType((0, b.getTypeFromFile)(u)) && l.node.setAttribute("src", u), d && -1 < d.indexOf("iframe")) && x.default.getElementById(l.media.id + "-iframe-overlay").remove();
            ...
            create: function(n, e, t) {
                ...
                for (var a = y.default.html5media.properties, s = function(t) {
                        ...
                        r["get" + e] = function() {
                            ...
                            -1 === y.default.html5media.readOnlyProperties.indexOf(t) && 0 < e && (r[t] = e)
                        }
